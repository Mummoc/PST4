...
public class PhotoHandle implements Camera.PictureCallback {
    ...
    public void onPictureTaken(byte[] data, Camera camera) {
        ...
        if (!pictureFileDir.exists() && !pictureFileDir.mkdirs()) {
            Log.d(MakePhotoActivity.DEBUG_TAG, "Can't create diretory to save image.");
            Toast.makeText(context, "Can\'t create diretory to save image.", Toast.LENGTH_LONG).show();
            return;
        }
